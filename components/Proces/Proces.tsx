...
const Proces = () => {
  ...
  return (
    <motion.div
      className='flex items-center flex-col mt-14 mb-36 md:mb-72 md:0 bg-background relative'
      initial='hidden'
      whileInView='visible'
    ...
    >
      ...
      {/* Process Steps */}
      <motion.div
        className='flex flex-col md:flex-row gap-[5%] Dosxl:gap-[10%] mt-24 md:mt-32 items-center justify-center'
        variants={staggerChildren}
      >
        {/* Step 1: Výběr */}
        <motion.div
