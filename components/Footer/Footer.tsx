  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link href="/Onas" className="text-[15px] sm:text-[20px]">
          O nás
        </Link>
        <Link href="/Cenik" className="text-[15px] sm:text-[20px]">
          Ceník
        </Link>
        <Link href="/Rozvrh" className="text-[15px] sm:text-[20px]">
          Rozvrh
        </Link>
        <Link href="/Kontakt" className="text-[15px] sm:text-[20px]">
          Kontakt
        </Link>
      </motion.div>
      ...
      {/* Social Media */}
      <motion.div
        className="flex flex-col items-center w-full sm:w-1/4 w-1/4 gap-3"
        variants={fadeInUp}
      >
